    ...
    class DepositController
    {
        ...
        private void ExportToPDF()
        {
            try
            {
                ...
                // Lấy thông tin giao dịch trực tiếp từ lastDepositViewData
                string transactionCode = lastDepositViewData.TransactionCode;
                string transactionDescription = lastDepositViewData.TransactionDescription;
                decimal amount = decimal.Parse(lastDepositViewData.Amount); // Sử dụng Amount từ lastDepositViewData
                string handledBy = currentEmployee?.EmployeeName ?? "Nhân viên"; // Lấy từ currentEmployee
