...
{
    public interface IEmployeeChangePasswordView
    {
    ...
    public partial class UC_EmployeeChangePassword : UserControl, IEmployeeChangePasswordView
    {
        ...
        public UC_EmployeeChangePassword()
        {
            InitializeComponent();
        }
